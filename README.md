...
It allows the user to add new recipes:

<img src=".readme_images/add_recipe_dialogue.png" alt="Add Recipe Dialogue" width="30%">

Loading takes some time via OpenAI so I poll ConjureAPI to fetch the recipes when they're done loading:

<img src=".readme_images/recipe_loading.png" alt="Recipe List" width="30%">

And once done you can view the interactive recipes guides generated by GPT-3.5:

<img src=".readme_images/recipe_detail_page_1.png" alt="Recipe Detail 1" width="30%">

<img src=".readme_images/recipe_detail_page_2.png" alt="Recipe Detail 2" width="30%">

<img src=".readme_images/recipe_detail_page_3.png" alt="Recipe Detail 3" width="30%">
...
The `Content Type` specified on ConjureAPI is: "Recipes"
